...
# installed.
TCL_PREFIX='/workspace/machine_learning_devops_engineer_nanodegree/miniconda3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/workspace/machine_learning_devops_engineer_nanodegree/miniconda3'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspace/machine_learning_devops_engineer_nanodegree/miniconda3/include -fdebug-prefix-map=/opt/conda/conda-bld/tk_1654088763175/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/workspace/machine_learning_devops_engineer_nanodegree/miniconda3=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /workspace/machine_learning_devops_engineer_nanodegree/miniconda3/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/lib -Wl,-rpath-link,/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/lib -L/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/include'
...
TCL_PACKAGE_PATH='{/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1654088763175/work/tcl8.6.12/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/workspace/machine_learning_devops_engineer_nanodegree/miniconda3/lib/libtclstub8.6.a'
